package com.aisyah.models.mapel;
...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        // TODO EDIT
        EditText a = Utils.createEditText(context, "namaMapel");
        inputContainer.addView(a);
        EditText b = Utils.createEditText(context, "kategorimapel");
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        // TODO EDIT
        EditText namaMapel = Utils.createEditText(context, "namaMapel");
        namaMapel.setText(model.namaMapel);
        inputContainer.addView(namaMapel);

        EditText kategoriMapel = Utils.createEditText(context, "kategoriMapel");
        kategoriMapel.setText(model.kategoriMapel);
        inputContainer.addView(kategoriMapel);

        updateButton.setOnClickListener(v -> {
            Map<String, Object> updatedModel = new HashMap<>();

            if (!Objects.equals(model.namaMapel, namaMapel.getText().toString())) {
                updatedModel.put("namaMapel", namaMapel.getText().toString());
            }

            if (!Objects.equals(model.kategoriMapel, kategoriMapel.getText().toString())) {
                updatedModel.put("kategoriMapel", kategoriMapel.getText().toString());
            }
