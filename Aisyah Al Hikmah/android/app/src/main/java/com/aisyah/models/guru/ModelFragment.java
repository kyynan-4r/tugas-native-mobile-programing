...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        // TODO EDIT
        EditText a = Utils.createEditText(context, "namaGuru");
        inputContainer.addView(a);
        EditText b = Utils.createEditText(context, "email");
        inputContainer.addView(b);
        EditText c = Utils.createEditText(context, "noTelepon");
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        // TODO EDIT
        EditText namaGuru = Utils.createEditText(context, "namaGuru");
        namaGuru.setText(model.namaGuru);
        inputContainer.addView(namaGuru);

        EditText email = Utils.createEditText(context, "email");
        email.setText(model.email);
        inputContainer.addView(email);

        EditText noTelepon = Utils.createEditText(context, "noTelepon");
        noTelepon.setText(String.valueOf(model.noTelepon));
        inputContainer.addView(noTelepon);

        updateButton.setOnClickListener(v -> {
            Map<String, Object> updatedModel = new HashMap<>();

            if (!Objects.equals(model.namaGuru, namaGuru.getText().toString())) {
                updatedModel.put("namaGuru", namaGuru.getText().toString());
            }
            ...
            if (!Objects.equals(model.noTelepon, noTelepon.getText().toString())) {
                updatedModel.put("noTelepon", noTelepon.getText().toString());
            }
