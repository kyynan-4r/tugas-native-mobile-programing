...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        // TODO EDIT
        EditText a = Utils.createEditText(context, "ruangan");
        inputContainer.addView(a);
        EditText b = Utils.createEditText(context, "status");
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        // TODO EDIT
        EditText ruangan = Utils.createEditText(context, "ruangan");
        ruangan.setText(String.valueOf(model.ruangan));
        inputContainer.addView(ruangan);

        EditText status = Utils.createEditText(context, "status");
        status.setText(model.status);
        inputContainer.addView(status);

        updateButton.setOnClickListener(v -> {
            Map<String, Object> updatedModel = new HashMap<>();

            if (!Objects.equals(model.ruangan, ruangan.getText().toString())) {
                updatedModel.put("ruangan", ruangan.getText().toString());
            }

            if (!Objects.equals(model.status, status.getText().toString())) {
                updatedModel.put("status", status.getText().toString());
            }
