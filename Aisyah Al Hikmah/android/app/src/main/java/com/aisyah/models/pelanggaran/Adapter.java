...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String[] arrayOfStrings = {
                ...
                String.format("detailPelanggaran: %s", data.detailPelanggaran),
                String.format("poinPelangaran: %s", data.poinPelanggaran),
                String.format("tanggal: %s", data.tanggal),
                String.format("siswaId: %s", data.siswaId),
                String.format("kelasId: %s", data.kelasId),
