...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        // TODO EDIT
        EditText a = Utils.createEditText(context, "namaSiswa");
        inputContainer.addView(a);
        EditText b = Utils.createEditText(context, "tglLahir");
        inputContainer.addView(b);
        EditText c = Utils.createEditText(context, "alamat");
        inputContainer.addView(c);
        EditText d = Utils.createEditText(context, "noTelepon");
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        // TODO EDIT
        EditText namaSiswa = Utils.createEditText(context, "namaSiswa");
        namaSiswa.setText(model.namaSiswa);
        inputContainer.addView(namaSiswa);

        EditText tglLahir = Utils.createEditText(context, "tglLahir");
        tglLahir.setText(model.tglLahir);
        inputContainer.addView(tglLahir);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.namaSiswa, namaSiswa.getText().toString())) {
                updatedModel.put("namaSiswa", namaSiswa.getText().toString());
            }

            if (!Objects.equals(model.tglLahir, tglLahir.getText().toString())) {
                updatedModel.put("tglLahir", tglLahir.getText().toString());
            }
