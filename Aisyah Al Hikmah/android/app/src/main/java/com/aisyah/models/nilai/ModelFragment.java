...
public class ModelFragment extends Fragment {
    ...
    public void showCreateModal() {
        ...
        // TODO EDIT
        EditText a = Utils.createEditText(context, "guruId");
        inputContainer.addView(a);
        EditText b = Utils.createEditText(context, "siswaId");
        inputContainer.addView(b);
        EditText c = Utils.createEditText(context, "mapelId");
        inputContainer.addView(c);
        EditText d = Utils.createEditText(context, "tanggal");
        inputContainer.addView(d);
        EditText e = Utils.createEditText(context, "nilaiSiswa");
        ...
        dialogView.findViewById(R.id.createButton).setOnClickListener(v -> {
            Model createdModel = new Model(
                    Utils.tryParseInt(a.getText().toString(),0),
                    Utils.tryParseInt(b.getText().toString(),0),
                    Utils.tryParseInt(c.getText().toString(),0),
                    d.getText().toString(),
    ...
    public void showUpdateModal(Integer id, Model model) {
        ...
        // TODO EDIT
        EditText guruId = Utils.createEditText(context, "guruId");
        guruId.setText(String.valueOf(model.guruId));
        inputContainer.addView(guruId);
        ...
        EditText mapelId = Utils.createEditText(context, "mapelId");
        mapelId.setText(String.valueOf(model.mapelId));
        inputContainer.addView(mapelId);

        EditText tanggal = Utils.createEditText(context, "tanggal");
        tanggal.setText(model.tanggal);
        inputContainer.addView(tanggal);

        EditText nilaiSiswa = Utils.createEditText(context, "nilaiSiswa");
        nilaiSiswa.setText(String.valueOf(model.nilaiSiswa));
        inputContainer.addView(nilaiSiswa);

        updateButton.setOnClickListener(v -> {
            Map<String, Object> updatedModel = new HashMap<>();

            if (!Objects.equals(model.guruId, guruId.getText().toString())) {
                updatedModel.put("guruId", guruId.getText().toString());
            }
            ...
            if (!Objects.equals(model.mapelId, mapelId.getText().toString())) {
                updatedModel.put("mapelId", mapelId.getText().toString());
            }
            ...
            if (!Objects.equals(model.nilaiSiswa, nilaiSiswa.getText().toString())) {
                updatedModel.put("nilaiSiswa", nilaiSiswa.getText().toString());
            }
