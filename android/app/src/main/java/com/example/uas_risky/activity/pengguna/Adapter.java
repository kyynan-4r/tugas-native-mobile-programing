package com.example.uas_risky.activity.pengguna;
...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TextView password = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(password);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ((TextView) holder.itemCountainer.getChildAt(1)).setText(String.format("password: %s", data.password));
