...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ((TextView) holder.itemCountainer.getChildAt(1)).setText(String.format("stok: %s", data.stok));
        ((TextView) holder.itemCountainer.getChildAt(2)).setText(String.format("harga: %s", data.harga));
