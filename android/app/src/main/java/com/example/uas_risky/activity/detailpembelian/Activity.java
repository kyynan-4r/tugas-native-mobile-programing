...
public class Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleActivity.setText("detailpembelian");
    ...
    private void showCreateModal() {
        ...
        // TODO Edit This Scarlet
        EditText pembelianid = Utils.createEditText(this, "pembelianid");
        inputContainer.addView(pembelianid);
        EditText produkid = Utils.createEditText(this, "produkid");
        inputContainer.addView(produkid);
        EditText kuririd = Utils.createEditText(this, "kuririd");
        inputContainer.addView(kuririd);
        EditText hargasatuan = Utils.createEditText(this, "hargasatuan");
        inputContainer.addView(hargasatuan);
        EditText jumlah = Utils.createEditText(this, "jumlah");
        inputContainer.addView(jumlah);
        EditText subtotal = Utils.createEditText(this, "subtotal");
        inputContainer.addView(subtotal);
        ...
        createButton.setOnClickListener(v -> {
            Model createdModel = new Model(
                    // TODO Edit This Scarlet
                    pembelianid.getText().toString(),
                    produkid.getText().toString(),
                    kuririd.getText().toString(),
                    Integer.parseInt(hargasatuan.getText().toString()),
