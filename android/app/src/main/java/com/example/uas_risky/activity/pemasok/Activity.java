...
public class Activity extends AppCompatActivity {
    ...
    private void showCreateModal() {
        ...
        EditText kontak = Utils.createEditText(this, "kontak");
        inputContainer.addView(kontak);
        EditText alamat = Utils.createEditText(this, "alamat");
        inputContainer.addView(alamat);
